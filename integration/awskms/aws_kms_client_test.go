...
func TestNewClientWithCredentialsWithGoodCredentialsCsv(t *testing.T) {
	...
	goodCsvCredFile := filepath.Join(srcDir, "tink_go_awskms/testdata/credentials_aws.csv")
...
func TestNewClientWithCredentialsWithGoodCredentialsIni(t *testing.T) {
	...
	credINIFile := filepath.Join(srcDir, "tink_go_awskms/testdata/credentials_aws.cred")
...
func TestNewClientWithCredentialsWithBadCredentials(t *testing.T) {
	...
	badCredFile := filepath.Join(srcDir, "tink_go_awskms/testdata/bad_access_keys_aws.csv")
