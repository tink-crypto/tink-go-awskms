...
func TestNewClientWithCredentialsWithGoodCredentialsCsv(t *testing.T) {
	...
	goodCsvCredFile := filepath.Join(srcDir, "tink_go_awskms/testdata/aws/credentials.csv")
...
func TestNewClientWithCredentialsWithGoodCredentialsIni(t *testing.T) {
	...
	credINIFile := filepath.Join(srcDir, "tink_go_awskms/testdata/aws/credentials.cred")
